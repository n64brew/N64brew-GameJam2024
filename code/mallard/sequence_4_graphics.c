...
void sequence_4_draw_press_start_to_skip()
{
    ...
    rdpq_sprite_blit(sequence_4_sprite_start_button,
                     RESOLUTION_320x240.width - sequence_4_sprite_start_button->width - 38,
                     RESOLUTION_320x240.height - sequence_4_sprite_start_button->height - 1,
                     &(rdpq_blitparms_t){
                         .scale_x = 1.0f,
                         .scale_y = 1.0f,
                     });
