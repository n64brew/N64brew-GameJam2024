...
extern "C"
{
    ...
    void ui_fontRegister(void)
    {
        ...
        txt_game_fontStyle.outline_color = ui_color(BLACK);

        txt_title_fontStyle.color = ui_color(WHITE);
        txt_title_fontStyle.outline_color = ui_color(N_BLUE);

        txt_bright_fontStyle.color = ui_color(YELLOW);
        txt_bright_fontStyle.outline_color = ui_color(BLACK);
        ...
        txt_titleParms = (rdpq_textparms_t){.style_id = STYLE_TITLE, .align = ALIGN_CENTER, .valign = VALIGN_CENTER};
